      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <Reveal>
          <div className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-text-main/70 sm:text-lg">
              FlexFinance is designed to help you move from confusiion to
              clarity with a workflow that is simple, visual, and easy to
              maintain.
            </p>
          </div>
        </Reveal>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3 items-stretch">
          {steps.map((step, index) => {
            ...
            return (
              <Reveal key={step.number} delay={index * 0.25} className="h-full">
                <div className="flex h-full flex-col rounded-4xl bg-background p-8 ring-1 ring-black/5 transition hover:-translate-y-1 hover:shadow-md">
